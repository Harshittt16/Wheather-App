...
const App = () => {
  ...
  const API_KEY = `da608b11163587748bee65eb0b0ac4c1`;

  const BASE_URL = `https://api.openweathermap.org/data/2.5/weather?q=${input}&appid=${API_KEY}`;
    <div className='text-white bg-blue-950 mt-4'>Hello world</div>
    ...
    <div className='max-w-md mx-auto mt-8 rounded-lg overflow-hidden shadow-lg bg-gray-100'>
      ...
      <div className='flex items-center bg-white border-b border-gray-200 p-2'>
        <input
          type="text"
          className="flex-1 appearance-none bg-transparentborder-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
